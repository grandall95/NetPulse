package page.gagerandall.netpulse.ui.components
...
fun ResultCard(
    ...
    Card(
        ...
        Column(
            ...
            HorizontalDivider(color = (if (containerColor == MaterialTheme.colorScheme.surface) MaterialTheme.colorScheme.onSurface else MaterialTheme.colorScheme.primary).copy(alpha = 0.08f))
